...
npx skills update backlink-analyzer -g -y
```

For a project-level install, omit `-g`; update a project installation with `npx skills update backlink-analyzer -p -y`.

This Skill is redistributed from [aaron-he-zhu/seo-geo-claude-skills](https://github.com/aaron-he-zhu/seo-geo-claude-skills) under Apache-2.0. The original author and homepage metadata are preserved, and the upstream license is included in this directory.
