...
## 十·五、「能排上去」和「能赚钱」是两个独立命题

【实测】一条赛道同时满足：低难度档有一百多个词、合计几十万月搜、加权 CPC 接近 $1，
且**二十多个独立新站在十五个月内进场并拿到首页，最新的域龄只有两个月，入场速度还在加速**。
所有选词指标都说「能做」。

把同类站的真实流量查出来（面板，不是模型）：自然流量落在几百到八千/月。
最好的那个跑了十一个多月才到八千，折成展示广告约一百美元/月，典型的约二十美元/月。
另有两个站——一个规模已达数百页、一个是四年多的老域名——**连面板收录门槛都没摸到**。

两条要记住的：

1. **低进入门槛恰恰是坏消息。** 「两个月的新域能进前十」证明窗口开着，
   同时证明**没有护城河**——你能两个月进去，别人下个月也能，而且已经有一批人在做同一件事。
   看到新进入者时间线在**加速**（每半年的新域数量递增），要读成「淘金潮末段」，
   不是「机会刚出现」。
2. **窗口开着，不代表窗口后面的房间大。** 排名可得性与流量规模是两件事；
   而搜索量估算与真实点击之间的落差，在泛型头词上可以差一个数量级（见 ②·六·四）。

操作规则：**量 / KD / SERP 窗口三道闸全过之后，还有第四道——
查同类站的真实流量并折成钱，再谈立项。** 漏掉第四道，
调研会在每一项技术指标上都正确，而结论整个是错的。

判据一句话：**你要的是「这个词能不能排上去」的答案，还是「排上去能赚多少钱」的答案？
前者不蕴含后者。**
