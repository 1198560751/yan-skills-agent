...
| **判据写在这里，操作说明写在各自的 md** | 同一件事在两处各写一份，改了一处另一处就静默过期，而两边看起来都正常。所以本文件的「怎么做」一列只给一句话加一个指路 |
...
| 检查项 | 状态 | 证据 | 日期 |
|---|---|---|---|
| 闸门 2 · TDK | ✅ | seo-audit 全站 42 URL 零 error，逐 URL 结果在 audit.md「TDK」一节 | 2026-08-28 |
